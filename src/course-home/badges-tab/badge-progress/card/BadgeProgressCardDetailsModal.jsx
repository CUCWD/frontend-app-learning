    ...
    */
    <>
      <div>
        ...
        <Hyperlink destination="#" target="_self" className="m-0 p-0" onClick={open}>
      ...
      <ModalDialog
        key={`card_details_modal_${progress.assertion.entityId}`}
        title={`${progress.badgeClass.displayName} Details`}
        isOpen={isOpen}
        onClose={close}
        size={modalSize}
          ...
          <div className="progress-details-header">
            <ModalDialog.Hero>
              <ModalDialog.Hero.Background
                className="mb-5"
              />
              <ModalDialog.Hero.Content style={{ maxWidth: '100%' }}>
                <ModalDialog.Title>
                  <div className="progress-details-title row">
                    <h2 className="col">{progress.badgeClass.displayName}</h2>
                  </div>
                  <div className="progress-details-description row">
                    <div className="col">
                ...
                <div className="progress-details-share-instructions row w-100 p-4">
                  <div className="share-introduction col col-12 pb-4">
                    ...
                    <p className="mb-4">
                      ...
                      You can also send the badge image file directly to others, and they can use a <Hyperlink destination="https://badgecheck.io/" target="_blank">badge verification service</Hyperlink> from Badgr to confirm your accomplishment.
